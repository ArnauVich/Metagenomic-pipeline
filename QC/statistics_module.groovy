OUT_DIR= "./QC_graphics_results/"
 //output directory for statistics summary
OUT_DIR_FIL= "./QC_graphics_results/filtered_graphics/statistics_graph/"
 //output directory for statistics summary
Statistics = {
...
Statistics_fil = {
	exec "mkdir ./QC_graphics_results/filtered_graphics/statistics_graph/"
